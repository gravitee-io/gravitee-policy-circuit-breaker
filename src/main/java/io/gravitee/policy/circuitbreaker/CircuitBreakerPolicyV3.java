 ...
 */
public class CircuitBreakerPolicyV3 {

    static final String CIRCUIT_BREAKER_OPEN_STATE = "CIRCUIT_BREAKER_OPEN_STATE";
    ...
    protected final CircuitBreakerPolicyConfiguration configuration;

    public CircuitBreakerPolicyV3(CircuitBreakerPolicyConfiguration configuration) {
